      ...
      >
        ...
        <div className="contact-header mb-4">
          ...
          <p className="text-[clamp(.85rem,1.3vw,.95rem)] text-brand-gray leading-[1.8]">
            Ready to increase your business visibility? Connect with Adsonify today.
          </p>
        </div>
          ...
          <div className="contact-left">
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-[0.8rem] text-brand-gray mt-1">Instant campaign support</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <p className="font-condensed text-[0.65rem] tracking-[3px] uppercase text-[rgba(255,208,0,0.5)] mb-1">Our Office</p>
                <p className="font-condensed text-[0.95rem] font-bold text-white tracking-[1px]">Kerala, India</p>
                <p className="text-[0.8rem] text-brand-gray mt-1">Serving cities across Kerala</p>
              </div>
            </div>
            ...
            <div className="border border-[rgba(255,208,0,0.12)] bg-[rgba(255,208,0,0.02)] rounded-sm p-8">
              ...
              {submitted ? (
                ...
                <div className="flex flex-col items-center text-center py-10">
                  ...
                  <p className="font-display text-[1.8rem] text-white mt-4">Message Sent!</p>
